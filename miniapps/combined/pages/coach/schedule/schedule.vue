  ...
  <view class="page">
    <view class="top-bar">
      ...
      <view class="top-actions">
        <button class="private-btn" size="mini" @click="goPrivateBookings">私教/陪练预约</button>
        <button class="switch-btn" size="mini" @click="switchRole">切换身份</button>
      </view>
    </view>
...
export default {
  ...
  methods: {
    ...
    goPrivateBookings() { uni.navigateTo({ url: '/pages/coach/private-bookings/private-bookings' }); },
    async loadSchedule() {
...
.page-title { font-size: 34rpx; font-weight: bold; color: #722ed1; }
.top-actions { display: flex; gap: 12rpx; }
.private-btn { background: #FF4D28; color: #fff; border-radius: 8rpx; font-size: 24rpx; }
.switch-btn { background: #722ed1; color: #fff; border-radius: 8rpx; font-size: 24rpx; }
